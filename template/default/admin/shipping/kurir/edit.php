        ...
        <div class="col-sm-12 col-md-4 mx-auto">
            ...
            <form method="post">
            	...
            	<div class="form-group">
            		...
            		<input type="text" name="nama" class="form-control" required value="<?=$kurir->nama?>">
            	</div>
                <div class="form-group">
                    <label>Harga</label>
                    <input type="text" name="harga" class="form-control" required value="<?=$kurir->harga_kirim?>">
                </div>
